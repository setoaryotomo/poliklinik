...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $queryCheckSameDay = "SELECT * FROM jadwal_periksa WHERE id_dokter = '$idDokter' AND hari = '$hari'";
    $resultCheckSameDay = mysqli_query($mysqli,$queryCheckSameDay);

    if (mysqli_num_rows($resultCheckSameDay)>0) {
